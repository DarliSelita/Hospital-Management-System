...
CREATE TABLE `product` (
  ...
  KEY `FK_Product_Billing` (`BillingID`),
  CONSTRAINT `FK_Product_Billing` FOREIGN KEY (`BillingID`) REFERENCES `billing` (`BillingID`)
...
INSERT INTO `product` VALUES (10,8,'book',1200.00);
...
-- Dump completed on 2024-01-22  9:31:56
